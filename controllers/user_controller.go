...
func CreateUser(c *fiber.Ctx) error {
	...
	if validationErr := validate.Struct(&user); validationErr != nil {
		return c.Status(http.StatusBadRequest).JSON(responses.UserResponse{Status: http.StatusBadRequest, Message: "errror", Data: &fiber.Map{"data": validationErr.Error()}})
	}
...
func EditUser(c *fiber.Ctx) error {
	...
	result, err := userCollection.UpdateOne(ctx, bson.M{"id": objId},
		bson.M{"$set": update})
...
func DeleteUser(c *fiber.Ctx) error {
	...
	return c.Status(http.StatusOK).JSON(
		responses.UserResponse{Status: http.StatusOK, Message: "success", Data: &fiber.Map{"data": "User deleted successfully"}},
	)
}
